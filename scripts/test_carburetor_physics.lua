...
assertGreater(six.engineCoef, single.engineCoef + 0.25, "six-carb applied engine coefficient")
assertGreater(six.engineCoef - single.engineCoef, 0.28, "single vs six torque gap (strong)")
assertGreater(six.engineCoef, 0.88, "six-carb standard-condition coefficient")
assertGreater(six.inductionEfficiency, single.inductionEfficiency + 0.25, "six-carb induction efficiency gap")
